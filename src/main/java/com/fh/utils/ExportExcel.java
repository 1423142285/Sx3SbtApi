...
public class ExportExcel {
    public static XSSFWorkbook exportExcel(List<?> list, Class clazz) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, FileNotFoundException {
